 ...
 * [CrewFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [CrewFragment.newInstance] factory method to
...
class CrewFragment : Fragment() {
    ...
    var myAdapter: CrewRecyclerViewAdapter? = null
    private var listener: OnFragmentInteractionListener? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        myAdapter = CrewRecyclerViewAdapter(requireContext())
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        crewRecyclerview.hasFixedSize()
        crewRecyclerview.layoutManager = layoutManager

        crewRecyclerview.adapter = myAdapter
    }
